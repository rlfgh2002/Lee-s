    ...
    return AlertDialog(
      content: Container(
        child: Column(
          children: [
            Container(
              child: Text(title, style: TextStyle(color: Statics.shared.colors.titleTextColor,fontWeight: FontWeight.bold, fontSize: Statics.shared.fontSizes.titleInContent)),
              margin: const EdgeInsets.only(top: 30),
              padding: const EdgeInsets.only(left: 50,right: 50),
              width: popUpWidth,
            ),
            Container(
              child: Text(content,style: TextStyle(color: Statics.shared.colors.subTitleTextColor,fontWeight: FontWeight.normal, fontSize: Statics.shared.fontSizes.subTitleInContent),textAlign: TextAlign.left,),
