  ...
  Widget build(BuildContext context) {
    ...
    return FlatButton(
      child: Container(child: Row(
        children: [
          Container(width: buttonSize,child: Text("공지", style: TextStyle(color: Statics.shared.colors.mainColor, fontWeight: FontWeight.w700, fontSize: Statics.shared.fontSizes.content)),
          ...
          Column(
            children: <Widget>[
              ...
              Container(child: Text(this.obj.regDate, style: TextStyle(color: Statics.shared.colors.captionColor, fontSize: Statics.shared.fontSizes.small)),width: (screenWidth - (paddingSize * 2)) - buttonSize,margin: const EdgeInsets.only(top: 10)),
            ],
